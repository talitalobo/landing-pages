...
# Inicia o objeto ggplot e define a base de dados a ser usada naquele plot
# ggplot(data=iris ...)

# aes (Aesthetics) descreve como as variáveis dos dados são mapeadas para elementos visuais
...
# Utilizando o operador '+' o gráfico é construindo adicionando camadas ao objeto ggplot criado acima
